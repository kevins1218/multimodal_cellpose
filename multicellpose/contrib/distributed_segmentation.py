...
import numpy as np
import scipy
import multicellpose.io
import multicellpose.models
import tifffile
import imagecodecs
...
def read_preprocess_and_segment(
    ...
    multicellpose.io.logger_setup(stdout_file_replacement=log_file)
    model = multicellpose.models.CellposeModel(**model_kwargs)
